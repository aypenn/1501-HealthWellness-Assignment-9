...
# def delete_element_from_db(element_type: str, element: object):
#
#     if element_type == "Meal":
#         health_database.delete_meal(element.id)
#
#     else:
#         health_database.delete_workout(element)
